...
def orders_order_queue_payment_success_customer(records):
    """
    ...
    return {
        'statusCode': 200,
        'body': "Successful lambda invocation Payment Success Dequeue for Customer"
    }


lambda_handler = orders_order_queue_payment_success_customer
